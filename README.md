...
Clone this repo on your local system and execute the GameExec.java class which has main method --> Give input on how many players want the game to play for minimum = 2 and maximum = 4.

Runs on any Environment which supports Java 1.8 or above.
